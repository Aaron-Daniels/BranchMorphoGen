...
python3 "$script_dir/validate_temporal_exports.py" \
    ...
    "$test_dir/TrackerUnit-KeypointTopology-Sample-1.csv"
...
for sample in 1 2; do
    for stem in KeypointEvents KeypointSnapshots KeypointLineage KeypointTopology; do
    ...
    python3 "$script_dir/validate_temporal_exports.py" \
        ...
        "$test_dir/run-a/TemporalTest-KeypointTopology-Sample-${sample}.csv"
done
